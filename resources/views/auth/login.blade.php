    ...
    <section class=" lg:px-16 bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-12 h-12 mr-2" src="{{ asset('images/kiddo_bazzar_logo.png') }}" alt="kiddo_bazzar">
                Kiddo Bazzar
            </a>
                        ...
                        <div class="flex flex-col justify-between gap-5">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm ">
                                    <label for="remember" class="text-sm text-gray-500 dark:text-gray-300">Remember
                                        me</label>
